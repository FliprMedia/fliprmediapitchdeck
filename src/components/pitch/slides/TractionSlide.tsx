...
const TractionSlide = () => (
  <SlideLayout>
    ...
    <div className="absolute top-[200px] right-[100px] w-[500px] h-[500px] bg-primary/3 rounded-full blur-[200px]" />

    <div className="relative z-10 flex flex-col h-full px-20 py-14">
      {/* Header */}
      <div className="text-primary font-mono text-sm tracking-widest mb-3 opacity-0 animate-fade-up">12 — TRACTION & EARLY PROOF</div>
      <h2 className="text-[42px] font-bold leading-tight mb-2 opacity-0 animate-fade-up" style={{ animationDelay: '0.1s' }}>
        Early proof, <span className="text-primary">strong category signal.</span>
      </h2>
