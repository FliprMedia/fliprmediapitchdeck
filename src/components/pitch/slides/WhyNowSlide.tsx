    ...
    <div className="relative z-10 flex flex-col h-full px-24 py-14">
      ...
      <div className="flex flex-1 gap-7 min-h-0">
            ...
            <div className="h-[250px]">
              <ResponsiveContainer width="100%" height="100%">
                <AreaChart data={marketData} margin={{ top: 5, right: 5, bottom: 0, left: -10 }}>
                  ...
                  <XAxis dataKey="year" stroke="hsl(240 5% 35%)" fontSize={10} tickLine={false} fontFamily="JetBrains Mono" />
                  <YAxis stroke="hsl(240 5% 35%)" fontSize={10} tickLine={false} axisLine={false} tickFormatter={v => `$${v}B`} fontFamily="JetBrains Mono" />
        ...
        <div className="flex-1 flex flex-col gap-2.5">
          {themes.map((theme, i) => (
            <div key={theme.title} className="glass-card p-4 flex items-start gap-3 opacity-0 animate-fade-up group hover:border-primary/20 transition-all"
              style={{ animationDelay: `${0.25 + i * 0.06}s` }}>
              <div className="w-9 h-9 rounded-xl bg-primary/8 border border-primary/12 flex items-center justify-center shrink-0 group-hover:bg-primary/12 transition-colors">
