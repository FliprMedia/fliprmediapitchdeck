...
const AudienceSlide = () => (
  <SlideLayout>
    ...
    <div className="absolute top-[300px] right-[200px] w-[500px] h-[500px] bg-accent/3 rounded-full blur-[180px]" />

    <div className="relative z-10 flex flex-col h-full px-20 py-14">
      {/* Header */}
      <div className="text-primary font-mono text-sm tracking-widest mb-3 opacity-0 animate-fade-up">07 — AUDIENCE & USERS</div>
      <h2 className="text-[42px] font-bold leading-tight mb-2 opacity-0 animate-fade-up" style={{ animationDelay: '0.1s' }}>
        Multiple high-value audiences, <span className="text-primary">one category hub.</span>
      </h2>
