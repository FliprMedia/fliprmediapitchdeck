        ...
        <div className="flex-1 flex flex-col gap-4">
          ...
          <div className="glass-card-elevated p-7 opacity-0 animate-scale-in" style={{ animationDelay: '0.2s' }}>
            <div className="grid grid-cols-3 gap-8 text-center">
              <div>
                ...
                <div className="text-[10px] text-muted-foreground/50 font-mono-brand tracking-[0.1em] uppercase mt-1">Raise Amount</div>
              </div>
              <div>
                <div className="text-[44px] font-black text-foreground stat-value">SAFE</div>
                <div className="text-[10px] text-muted-foreground/50 font-mono-brand tracking-[0.1em] uppercase mt-1">Instrument</div>
              </div>
              <div>
                <div className="text-[44px] font-black text-accent stat-value">12–18</div>
                <div className="text-[10px] text-muted-foreground/50 font-mono-brand tracking-[0.1em] uppercase mt-1">Months Runway</div>
              </div>
            </div>
          </div>
          ...
          <div className="glass-card p-5 flex-1 opacity-0 animate-fade-up" style={{ animationDelay: '0.35s' }}>
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="text-[12px] font-bold text-foreground">What This Round Unlocks</span>
            </div>
          ...
          <div className="opacity-0 animate-fade-up" style={{ animationDelay: '0.7s' }}>
            <span className="text-[10px] font-mono-brand text-muted-foreground/40 tracking-[0.15em] uppercase block mb-2">Ideal Investors</span>
            <div className="flex flex-wrap gap-2">
              {idealInvestors.map(inv => (
                <div key={inv} className="glass-card px-3 py-1.5 text-[10px] font-semibold text-foreground/70">{inv}</div>
              ))}
            </div>
          </div>
        </div>
        ...
        <div className="w-[460px] flex flex-col gap-4">
          ...
          <div className="glass-card p-5 opacity-0 animate-fade-up" style={{ animationDelay: '0.65s' }}>
            <div className="flex items-center gap-2 mb-3">
              ...
              <span className="text-[11px] font-bold text-foreground">Founder Contact</span>
            </div>
            <div className="space-y-2">
              {[
                ...
                <div key={item.label} className="flex items-center gap-3">
                  <span className="text-[9px] text-muted-foreground/40 font-mono-brand tracking-[0.1em] uppercase w-12">{item.label}</span>
